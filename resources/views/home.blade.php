...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="https://icons8.com/icon/12975/barbell">
...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="main-button" id="loginButton"><a href="login">Sign In</a></li>
                        </ul>
    ...
    <section class="section" id="pricing">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        <h2>Our <em>Pricing</em></h2>
                        <img src="assets/images/line-dec.png" alt="waves">
                        <p>Choose the best plan that fits your needs and become a member today.</p>
                    </div>
                </div>
            </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; 2024 Training Studio
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function isUserLoggedIn() {
                ...
                return true; // Example: user is logged in
            }

            if (isUserLoggedIn()) {
                document.getElementById('userProfileButton').style.display = 'inline-block';
            }
        });
    </script>
</body>
